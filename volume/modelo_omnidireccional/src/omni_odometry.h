...
class OmniOdometry : public rclcpp::Node
{
  ...
  private:
    ...
    rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr vel_pub_fl_wheel_;
    rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr vel_pub_fr_wheel_;
    rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr vel_pub_rl_wheel_;
    rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr vel_pub_rr_wheel_;
